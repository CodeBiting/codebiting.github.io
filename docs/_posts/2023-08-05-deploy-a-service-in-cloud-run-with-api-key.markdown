...
paths:
  /v1/products:
    get:
      ...
      x-google-backend:
        address: https://g2l-test-server-auxawjespa-uc.a.run.app/v1/products
      security:
      - api_key: []
      responses:
        '200':
...
7. Click in the API Gateway to see the details, in "Gateways" tab, copy the external URL generated by Google, ex: `https://g2l-integration-gateway-8g7k8sqn.ew.gateway.dev`
8. Copy the managed service name so secure the API with a key, ex: `g2l-integration-api-v1-0lkrtuapa7pzy.apigateway.g2l-integration.cloud.goog`

Enable the managed service:

1. Go to [APIs and services -> Enabled APIs and services](https://console.cloud.google.com/apis/dashboard), search by the Cloud Run Service managed service name, and enable it. it can be enabled with the command `gcloud services enable g2l-integration-api-v1-0lkrtuapa7pzy.apigateway.g2l-integration.cloud.goog`
...
```bash
curl https://g2l-test-server-auxawjespa-uc.a.run.app/v1/products
...
curl -H "Authorization: Bearer $TOKEN" -H 'Content-Type: text/plain' -d '**Hello Bold Text**' https://onion-g2l-test-server-auxawjespa-uc.a.run.app/v1/products
[ ... ]
```
...
```bash
curl https://g2l-integration-gateway-8g7k8sqn.ew.gateway.dev/v1/products
...
```bash
curl --location --request GET 'https://g2l-integration-gateway-8g7k8sqn.ew.gateway.dev/v1/products' \
--header 'Content-Type: application/json' \
--header 'x-api-key: AIzaSyCXTEiM4yf4nCSIrLrTQa1_GA_zZBFz3eo'
...
```bash
curl --location --request GET 'https://g2l-integration-gateway-8g7k8sqn.ew.gateway.dev/v1/products' --header 'Content-Type: application/json' --header 'x-api-key: EEEEEEEEEEEEEEEEEEEEE'
...
```bash
curl --location --request GET 'https://g2l-integration-gateway-8g7k8sqn.ew.gateway.dev/v1/products' --header 'Content-Type: application/json' --header 'x-api-key: AIzaSyCXTEiM4yf4nCSIrLrTQa1_GA_zZBFz3ea'
[ ... ]
```
